...
export async function POST(request: NextRequest) {
  try {
    ...
    switch (documentType) {
      case "id_card":
        systemPrompt +=
          "Verify if this is a valid ID card. Check for signs of tampering, inconsistencies, and extract personal information.";
        break;
      case "pay_slip":
        systemPrompt +=
          "Analyze this pay slip to verify its authenticity. Extract income information, employer details, and payment period.";
        break;
      case "profile_image":
        systemPrompt +=
          "Verify if this image appears to be a genuine profile photo of a real person. Look for any signs of AI generation or manipulation.";
        break;
      default:
        systemPrompt +=
          "Verify the authenticity of this document and extract key information.";
    }
